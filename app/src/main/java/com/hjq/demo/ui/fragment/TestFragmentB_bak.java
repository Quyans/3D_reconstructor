 ...
 *    desc   : 项目自定义控件展示
 */
public final class TestFragmentB_bak extends MyFragment<HomeActivity>
    ...
    public static TestFragmentB_bak newInstance() {
        return new TestFragmentB_bak();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_test_b_bak;
    }
